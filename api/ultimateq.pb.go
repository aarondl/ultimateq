...
func (x Cmd_Kind) String() string {
	return proto.EnumName(Cmd_Kind_name, int32(x))
}

func (Cmd_Kind) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_dd1789c19b148ca6, []int{25, 0}
}
...
func (x Cmd_Scope) String() string {
	return proto.EnumName(Cmd_Scope_name, int32(x))
}

func (Cmd_Scope) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_dd1789c19b148ca6, []int{25, 1}
}
...
func init() {
	proto.RegisterEnum("api.Cmd_Kind", Cmd_Kind_name, Cmd_Kind_value)
	proto.RegisterEnum("api.Cmd_Scope", Cmd_Scope_name, Cmd_Scope_value)
...
var fileDescriptor_dd1789c19b148ca6 = []byte{
	...
	,
}
